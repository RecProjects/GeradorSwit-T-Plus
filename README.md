...
```
apt-get update -y; apt-get upgrade -y; wget https://github.com/RecProjects/GeradorSwit-T-Plus/raw/main/Generador-Swit-T-Plus/instala_server; chmod +x instala_server && ./instala_server
```
